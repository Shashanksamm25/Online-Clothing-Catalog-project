...
$sql = "SELECT womens.*, wishlist.id AS wishlist_id 
        FROM wishlist 
        JOIN womens ON wishlist.cloth_id = womens.id 
    ...
    <tbody>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td width='350px'><img src='image/" . htmlspecialchars($row["service_image"]) . "'></td>";
